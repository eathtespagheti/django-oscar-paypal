...
class EdgeCaseTests(BasketMixin, TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.url = reverse('checkout-redirect')
...
class PreviewOrderTests(BasketMixin, TestCase):
    ...
    def setUp(self):
        ...
        url = reverse('checkout-success-response', kwargs={'basket_id': basket.id})
...
class SubmitOrderMixin(BasketMixin):
    ...
    def setUp(self):
        ...
        self.url = reverse('checkout-place-order', kwargs={'basket_id': self.basket.id})
        self.payload = {
            'action': 'place_order',
...
class SubmitOrderTests(SubmitOrderMixin, TestCase):
    ...
    def test_create_order_when_bayer_pays_on_paypal(self):
        url = reverse('checkout-handle-order', kwargs={'basket_id': self.basket.id})
        query_string = urlencode({'PayerID': '0000000000001', 'token': '4MW805572N795704B'})
...
class CancelOrderTests(BasketMixin, TestCase):
    ...
    def test_cancel_order(self):
        ...
        url = reverse('checkout-cancel-response', kwargs={'basket_id': basket.id})
